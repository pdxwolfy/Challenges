...
class MatrixTest < Minitest::Test
  ...
  def test_extract_same_row_again
    ...
    assert_equal [8, 6], matrix.rows[1]
  end
  ...
  def test_extract_other_row_again
    ...
    assert_equal [1, 4, 9], matrix.rows[0]
  ...
  def test_extract_a_column
    ...
    assert_equal [2, 5, 8, 7], matrix.columns[1]
    assert_equal [3, 6, 9, 6], matrix.columns[2]
  end

  def test_extract_another_column
    matrix = Matrix.new("89 1903 3\n18 3 1\n9 4 800")
    assert_equal [89, 18, 9], matrix.columns[0]
    assert_equal [1903, 3, 4], matrix.columns[1]
    assert_equal [3, 1, 800], matrix.columns[2]
  end
