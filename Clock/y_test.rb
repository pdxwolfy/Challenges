...
class ClockTest < Minitest::Test
  ...
  def test_wrap_subtract_one_day
    clock = Clock.at(0, 30) - 24 * 60
    assert_equal '00:30', clock.to_s
  end
  ...
  def test_wrap_subtract_one_day_and_a_bit_more
    clock = Clock.at(0, 30) - (24 * 60 + 45)
    assert_equal '23:45', clock.to_s
  end
end
